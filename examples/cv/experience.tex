...
%---------------------------------------------------------
  \cventry
    {Web Application Developer Contractor} % Job title
    {Swift Soul Interactive} % Organization
    {} % Location
    {July 2022 - Present} % Date(s)
    {
      \begin{cvitems} % Description(s) of tasks/responsibilities
        \item {Designed and implemented features in a NextJs + Firebase solution}
        \item {Implemented scheduled Cloud Functions that interacts with Firebase and a third-party API}
      \end{cvitems}
    }

%---------------------------------------------------------
  \cventry
    {Software Engineer Junior III} % Job title
    {GBH} % Organization
    {} % Location
    {April 2022 - October 2022} % Date(s)
    {
      \begin{cvitems} % Description(s) of tasks/responsibilities
        \item {Integrated with a mature team for implementing features for a data-intensive solution}
        \item {Enhanced forms to perform complex and efficient queries to the databases}
        \item {Optimized SQL queries across the application}
        \item {Migrated front-end views to a modern solution within the Phoenix-Elixir ecosystem (LiveView) }
      \end{cvitems}
    }

%---------------------------------------------------------
  \cventry
    {Software Engineer Junior II} % Job title
    {GBH} % Organization
    {} % Location
    {April 2021 - April 2022} % Date(s)
    {
      \begin{cvitems} % Description(s) of tasks/responsibilities
        \item {Participated in the development of an internal application for managing projects and resources allocations.}
        \item {Developed the API for managing a data-intensive application.}
        \item {Reviewed the code of fellow software engineers to the current standards and defined conventions.}
        \item {Followed the SCRUM methodology on a day-to-day basis.}
      \end{cvitems}
    }

%---------------------------------------------------------
  \cventry
    {Assessment Consultant} % Job title
    {Woven} % Organization
    {} % Location
    {June 2020 - June 2021} % Date(s)
    {
      \begin{cvitems} % Description(s) of tasks/responsibilities
        \item {Tested engineering assessments effectively in diverse programming languages and frameworks (JavaScript, React, Ruby).}
        \item {Evaluated software engineers' code quality & practices based on industry standards for diverse ecosystems.}
        \item {Improved internal processes documentation readability.}
      \end{cvitems}
    }
...
%---------------------------------------------------------
  \cventry
    ...
    {Freelancer - Upwork} % Organization
    {} % Location
    {July 2020 - March 2021} % Date(s)
    {}
